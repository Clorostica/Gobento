...
const TaskCardContent: React.FC<TaskCardContentProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Shared-from pin icon — shown when this event was copied from another user */}
      {!!task.sharedFromUserId && !isReadOnly && (
        <div
          className="absolute -top-2 -left-2 z-30 flex items-center justify-center pointer-events-none select-none"
          style={{
            width: 22,
            height: 22,
            borderRadius: "50%",
        ...
        >
          {/* Share / repost pin icon */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style={{ width: 11, height: 11, color: "white" }}>
